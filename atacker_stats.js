...
module.exports = {
	set_stats: ({ level, ATK, PEN_ratio, PEN, AP, crit_chance, crit_damage, total_damage_bonus, crit_mode, atribute_bonus_damage }) => {
        ...
        agent_stats.ATK = ATK;
        agent_stats.PEN_ratio = PEN_ratio;
        agent_stats.PEN = PEN;
        agent_stats.AP = AP;
		agent_stats.crit_mode = crit_mode;
        agent_stats.crit_chance = crit_chance;
        agent_stats.crit_damage = crit_damage;
		agent_stats.total_damage_bonus = total_damage_bonus;
		agent_stats.atribute_bonus_damage = atribute_bonus_damage;
	},
	...
	set_mindscape: (level) => agent_stats.mindscape_level = level,
